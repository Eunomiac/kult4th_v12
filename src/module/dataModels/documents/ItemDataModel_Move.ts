...
export default class ItemDataModel_Move extends TypeDataModel<typeof ItemSchemaMove, Item.ConfiguredInstance, EmptyObject, InterfaceToObject<ItemDerivedData_Move>> {
