...
export default class ItemDataModel_Move extends TypeDataModel<typeof ItemSchema_Move, Item.ConfiguredInstance, EmptyObject, InterfaceToObject<ItemDerivedData_Move>> {
