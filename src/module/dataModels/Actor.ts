...
export class ActorDataModel_PC extends TypeDataModel<typeof ActorSchema_PC, Actor.ConfiguredInstance> {
  static override defineSchema() {
    return {...super.defineSchema(), ...ActorSchema_PC};
  }
}
...
export class ActorDataModel_NPC extends TypeDataModel<typeof ActorSchema_NPC, Actor.ConfiguredInstance> {
  static override defineSchema() {
    return {...super.defineSchema(), ...ActorSchema_NPC};
  }
}
